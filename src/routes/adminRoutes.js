...
// Manage Mahasiswa
router.get("/mahasiswa", adminController.getAllDataMahasiswa);
router.post("/mahasiswa", adminController.createDataMahasiswa);
router.get("/mahasiswa/:id", adminController.getDataMahasiswaById);
router.put("/mahasiswa/:id", adminController.updateDataMahasiswa);
router.delete("/mahasiswa/:id", adminController.deleteDataMahasiswa);
